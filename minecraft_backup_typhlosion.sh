...
rsync -av /mnt/cyndaquil/CC_Backup/crazycraft-typhlosion_"$(date +%F)".7z jesse@iolite:/mnt/Backup/Minecraft/CC_Backup/

# Cleanup old World Data Backups
rm -Rvf /mnt/cyndaquil/CC_Backup/worlddata/*
echo "Done"
